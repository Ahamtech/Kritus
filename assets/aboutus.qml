        ...
        Container {
            ...
            Container {
                ...
                Container {
                    ...
                    Label {
                        textFormat: TextFormat.Html
                        text: "<html><body><a href='mailto:kritus@ahamtech.in'>kritus@ahamtech.in</a></body></html>"
                    }
                }
            ...
            Container {
                ...
                Label {
                    ...
                    text: "Kritus is a thrird party clint for 'Basecamp' and also a pure native app for BlackBerry 10, we request you to send us any suggestions, feedback and improvements required."
                    multiline: true
                    textStyle.fontStyle: FontStyle.Italic
                }
            }
...
<span><b>Front End Programmer</b></span><span><i>    Mahesh Reddy</i></span></body></html>"
        ...
        attachedObjects: [
            Invocation {
                ...
                query.uri: "mailto:kritus@ahamtech.in?subject=kritus-Feedback"
            }
        ]
    }
}